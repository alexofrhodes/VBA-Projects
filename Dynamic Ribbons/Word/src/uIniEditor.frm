...
Private Sub Label1_Click()
    FollowLink ThisDocument.Path & "\ExtraIniPaths.txt"
End Sub
...
Private Sub UserForm_Initialize()
    ...
    FolderContents ThisDocument.Path, False, True, True, out, "*.ini"
...
Private Sub cbIniFiles_BeforeUpdate(ByVal Cancel As MSForms.ReturnBoolean)
    ...
    If InStr(1, ini, ":") = 0 Then ini = Replace(ThisDocument.Path & "\" & ini, "\\", "\")
    ...
    If Not ListContains(cbIniFiles, ini, 1, False) Then
        ...
        If InStr(1, ini, ThisDocument.Path) = 0 Then
            Dim ExtraIniPathsFile As String
                ExtraIniPathsFile = ThisDocument.Path & "\ExtraIniPaths.txt"
